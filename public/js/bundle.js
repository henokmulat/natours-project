...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  console.log('Alert displayed:', markup);
...
// DOM ELements
var mabox = document.getElementById('map');
